...
// Demo data
const ORDERS_TREND_DATA = [
  { date: 'Jan 1', orders: 142 },
  { date: 'Jan 8', orders: 198 },
  { date: 'Jan 15', orders: 165 },
  { date: 'Jan 22', orders: 221 },
  { date: 'Feb 1', orders: 189 },
  { date: 'Feb 8', orders: 256 },
  { date: 'Feb 15', orders: 234 },
  { date: 'Feb 22', orders: 312 },
]
...
const TOP_PRODUCTS_DATA = [
  { product: 'Tablet Stand', orders: 428, revenue: 24500, avgQty: 2.1, trend: 'up' },
  { product: 'Tablet Case', orders: 392, revenue: 23800, avgQty: 1.8, trend: 'up' },
  { product: 'Bluetooth Adapter', orders: 356, revenue: 22900, avgQty: 2.0, trend: 'down' },
  { product: 'USB-C Cable', orders: 318, revenue: 22100, avgQty: 2.4, trend: 'up' },
  { product: 'Wireless Headphones', orders: 284, revenue: 19400, avgQty: 1.5, trend: 'up' },
]
...
const Orders = () => {
  ...
  const growth = 8.4
  const completedOrders = 2840
  const pendingOrders = 730
  const cancelledOrders = 156

  const maxRegionOrders = Math.max(...REGION_DATA.map((r) => r.orders))
            ...
            <div className="orders-grid">
              ...
              <div className="orders-card orders-card--8">
                ...
                <div className="orders-chart-wrap">
                  <ResponsiveContainer width="100%" height={240}>
                    <LineChart data={ORDERS_TREND_DATA} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
              ...
              <div className="orders-card orders-card--6">
                ...
                <div className="orders-bars-wrap">
                  <ResponsiveContainer width="100%" height={260}>
                    <BarChart data={CHANNEL_DATA} layout="vertical" margin={{ top: 0, right: 24, left: 80, bottom: 0 }}>
                      ...
                      {TOP_PRODUCTS_DATA.map((row, i) => (
                        <tr key={i}>
                          ...
                          <td className="orders-table__trend">
                            {row.trend === 'up' ? (
                              <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M8 12V4M8 4L5 7M8 4l3 3" stroke="#16a34a" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                            ) : (
                              <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M8 4v8M8 12l-3-3M8 12l3-3" stroke="#dc2626" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                            )}
                          </td>
                        </tr>
                      ))}
